...
# use these headers 
TARGET_SPECIFIC_HEADER_PATH := device/ixion/m350/include
...
BOARD_USERDATAIMAGE_PARTITION_SIZE := 4823449600
BOARD_CACHEIMAGE_PARTITION_SIZE := 406218342
#pagesize * 64
...
#TARGET_KERNEL_SOURCE := kernel/ixion/m350
...
# Stock_kernel
TARGET_PREBUILT_KERNEL := device/ixion/m350/kernel
 
# prebuild kernel as fallback
#TARGET_PREBUILT_KERNEL := device/ixion/m350/prebuilt/kernel
...
# system.prop
TARGET_SYSTEM_PROP := device/ixion/m350/system.prop

# CyanogenMod Hardware Hooks
BOARD_HARDWARE_CLASS := device/ixion/m350/cmhw/
...
BOARD_BLUETOOTH_BDROID_BUILDCFG_INCLUDE_DIR := device/ixion/m350/bluetooth
...
BOARD_EGL_CFG := device/ixion/m350/egl.cfg
BOARD_EGL_WORKAROUND_BUG_10194508 := true

# SELinux
BOARD_SEPOLICY_DIRS := \
       device/ixion/m350/sepolicy
...
# recovery
#TARGET_RECOVERY_INITRC := device/ixion/m350/recovery/init.mt6735.rc
TARGET_RECOVERY_FSTAB := device/ixion/m350/recovery/root/fstab.mt6753
